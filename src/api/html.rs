    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                if elem.is_some(){
                    let el = elem.unwrap();
                    return Ok(Value::String(engine.create_string(&el.html()).unwrap()));
                }else{
                    return Ok(Value::Null);
                }
            }else{
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let ancestors = &mut elem.ancestors();
                let elems_arr = engine.create_array();
                let mut new_elem_ref_hash:HashMap<String, NodeId> = HashMap::new();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let descendants = &mut elem.descendants();
                let elems_arr = engine.create_array();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let child_opt = elem.first_child();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let fchildren = &mut elem.first_children();
                let elems_arr = engine.create_array();

                let mut new_elem_ref_hash:HashMap<String, NodeId> = HashMap::new();
                for elem in fchildren{
                    let eid = Uuid::new_v4().to_string();                    
                    let elem_obj = engine.create_object();
                    elem_obj.set(DOC_ID, doc_id.clone()).unwrap();
                    elem_obj.set(ID, eid.clone()).unwrap();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let lchildren = &mut elem.last_children();
                let elems_arr = engine.create_array();

                let mut new_elem_ref_hash:HashMap<String, NodeId> = HashMap::new();
                for elem in lchildren{
                    let eid = Uuid::new_v4().to_string();                    
                    let elem_obj = engine.create_object();
                    elem_obj.set(DOC_ID, doc_id.clone()).unwrap();
                    elem_obj.set(ID, eid.clone()).unwrap();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let child_opt = elem.next_sibling();
                if child_opt.is_none(){
                    return Ok(Value::Null);
                }
                let child = child_opt.unwrap();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let nsiblings = &mut elem.next_siblings();
                let elems_arr = engine.create_array();

                let mut new_elem_ref_hash:HashMap<String, NodeId> = HashMap::new();
                for elem in nsiblings{
                    let eid = Uuid::new_v4().to_string();                    
                    let elem_obj = engine.create_object();
                    elem_obj.set(DOC_ID, doc_id.clone()).unwrap();
                    elem_obj.set(ID, eid.clone()).unwrap();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let child_opt = elem.prev_sibling();
                if child_opt.is_none(){
                    return Ok(Value::Null);
                }
                let child = child_opt.unwrap();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                let elem = elem_opt.unwrap();
                let siblings = &mut elem.prev_siblings();
                let elems_arr = engine.create_array();
    ...
    if this.contains_key(ID).unwrap(){
        ...
        if node_res.is_some(){
            ...
            if node_opt.is_some(){
                ...
                if elem.is_some(){
                    let el = elem.unwrap();
                    return Ok(Value::String(engine.create_string(&el.value().name()).unwrap()));
                }else{
                    return Ok(Value::Null);
                }
            }else{
